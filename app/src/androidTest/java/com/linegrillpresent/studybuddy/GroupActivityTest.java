...
public class GroupActivityTest {
    ...
    @Test
    public void groupActivityTest2() {
        ...
        ViewInteraction appCompatCheckedTextView = onView(
                allOf(withId(R.id.design_menu_item_text), withText("My Groups"), isDisplayed()));
        appCompatCheckedTextView.perform(click());

        ViewInteraction textView = onView(
                allOf(withText("You have registered for 12 groups:")
                        ));
        textView.check(matches(withText("You have registered for 12 groups:")));

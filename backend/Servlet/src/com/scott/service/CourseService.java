	...
	@Override
	 ...
	 protected void doGet(HttpServletRequest req, HttpServletResponse resp)
	        ...
	        try{
		        ...
		        switch(action){
		        case "getAllAvailableCourses"://get all courses
		        ...
		        case "listCourses"://get courses that user is enrolled in
		        	...
		        	break;
		        case "listGroupsUnderCourse"://show all groups under course
					int courseId = Integer.parseInt(req.getParameter("courseId"));
					List<String> courseNameList = courseDao.getGroupByCourse(conn, courseId);
					resp.getWriter().write(new Gson().toJson(courseNameList));
					break;
		        case "registerCourse"://register a new course
		        	...
		        	break;
		        case "dropCourse"://drop a course
		        	String userName = user.getName();
		        	int id = Integer.parseInt(req.getParameter("courseId"));
		        	courseDao.dropCourse(conn, userName, id);
		        	resp.getWriter().write("succeed");
		        	break;
		        default:
